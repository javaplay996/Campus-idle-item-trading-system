    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="闲置物品名称" prop="shangpinName">
                       <el-input v-model="ruleForm.shangpinName"
                                 placeholder="闲置物品名称" clearable  :readonly="ro.shangpinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="闲置物品名称" prop="shangpinName">
                           <el-input v-model="ruleForm.shangpinName"
                                     placeholder="闲置物品名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangpinPhoto" label="闲置物品照片" prop="shangpinPhoto">
                        <file-upload
                            tip="点击上传闲置物品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinPhoto" label="闲置物品照片" prop="shangpinPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="闲置物品类型" prop="shangpinTypes">
                        <el-select v-model="ruleForm.shangpinTypes" :disabled="ro.shangpinTypes" placeholder="请选择闲置物品类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="闲置物品类型" prop="shangpinValue">
                        <el-input v-model="ruleForm.shangpinValue"
                            placeholder="闲置物品类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="闲置物品库存" prop="shangpinKucunNumber">
                       <el-input v-model="ruleForm.shangpinKucunNumber"
                                 placeholder="闲置物品库存" clearable  :readonly="ro.shangpinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="闲置物品库存" prop="shangpinKucunNumber">
                           <el-input v-model="ruleForm.shangpinKucunNumber"
                                     placeholder="闲置物品库存" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="原价" prop="shangpinOldMoney">
                       <el-input v-model="ruleForm.shangpinOldMoney"
                                 placeholder="原价" clearable  :readonly="ro.shangpinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="原价" prop="shangpinOldMoney">
                           <el-input v-model="ruleForm.shangpinOldMoney"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="闲置物品简介" prop="shangpinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.shangpinContent" label="闲置物品简介" prop="shangpinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinName: [
                              { required: true, message: '闲置物品名称不能为空', trigger: 'blur' },
                          ],
                   shangpinPhoto: [
                              { required: true, message: '闲置物品照片不能为空', trigger: 'blur' },
                          ],
                   shangpinTypes: [
                              { required: true, message: '闲置物品类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinKucunNumber: [
                              { required: true, message: '闲置物品库存不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   shangpinContent: [
                              { required: true, message: '闲置物品简介不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
